...
\section{Muestreo de la hemiesfera}
...
Hay que hacer notar que en la instrucción \emph{color += brdfLight * Kd;} no estamos multiplicando por el típico factor coseno de la normal y la luz. No lo hacemos porque al tomar la muestra con densidad coseno y dividir entre la densidad de probabilidad de esa muestra los factores coseno se anulan.
